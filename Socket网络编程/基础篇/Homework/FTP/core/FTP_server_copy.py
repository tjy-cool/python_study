        ...
        while True:
            ...
            while True:
                ...
                if command.decode() == "login":  # 登陆
                    self.in_login(user_data, conn)    # 登陆
